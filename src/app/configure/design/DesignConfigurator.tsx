    ...
    return <div className='relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20'>
        ...
        <div className='h-[37.5rem] w-full col-span-full lg:col-span-1 flex flex-col bg-white'>
                                ...
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent>
                                        {MODELS.options.map((model) => (
                                            <DropdownMenuItem 
                                            key={model.label} 
                                            className={cn("flex text-sm gap-1 item-center p-1.5 cursor-default hover:bg-zinc-100",
                                ...
                                <div className="mt-3 space-y-4">
                                    {selectableOptions.map((option) => (
                                        ...
                                        {'border-primary': active || checked})}>
                                            ...
                                            <RadioGroup.Description
                                            as="span"
                                            className="mt-2 flex text-sm sm:ml-4 smLmt_0 sm:flex-col sm:text-right">
            ...
            <div className="w-full px-8 h-16 bg-white">
                ...
                <div className="w-full h-full flex justify-end justify-center">
                    <div className="w-full flex gap-6 items-center">
                        <p className='front-medium whitespace-nowrap'>
